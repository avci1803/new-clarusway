...
const moreThan1000 = salaries.filter((s) => s >= 10000);
...
const totalSalary = salaries.reduce((total, salary) => total + salary);
...
console.log("sumOfRaisedSalaries : ", sumOfRaisedSalaries);
